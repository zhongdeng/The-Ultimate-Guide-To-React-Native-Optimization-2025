...
![](../assets/1.png "React Native 新架构下的简化线程模型，展示了 JavaScript 的执行上下文")
...
![](../assets/2.png "React 协调（Reconciliation）算法的可视化描述")
...
### 下一篇：[如何分析 JavaScript 和 React 的性能](./1.How_to_Profile_JS_and_React_Code.md)
