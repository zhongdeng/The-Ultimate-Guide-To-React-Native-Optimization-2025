...
> 如果你没有看到 “JavaScript Profiler” 选项卡，可以点击右上角的齿轮图标进入设置，在实验性功能中启用 JavaScript Profiler。（译者：0.78 以后找不到这个开关了, [详情见](https://github.com/facebook/react-native-devtools-frontend/pull/144)）
