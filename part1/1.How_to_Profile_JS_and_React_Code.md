...
现在，打开 React Native DevTools，切换到顶部的 Profiler 选项卡。点击齿轮按钮（译者：是 Profiler 选项卡下的齿轮按钮，而不是最右上角的齿轮按钮），勾选`Highlight updates when components render`
...
> 如果你没有看到 “JavaScript Profiler” 选项卡，可以点击右上角的齿轮图标进入设置，在实验性功能中启用 JavaScript Profiler。（译者：不知道出于什么原因，0.78 以后这个开关就被移除了, 详情见：[react-native-devtools-frontend](https://github.com/facebook/react-native-devtools-frontend/pull/144) 和 [devtools-frontend](https://github.com/ChromeDevTools/devtools-frontend/commit/6db489bfeff7eb67bbcec14d9ec17ceccd5b63c6)）
...
### 下一篇：[如何测量 JavaScript 的帧率](./2.How_to_Measure_JS_FPS.md)
